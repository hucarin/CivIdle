export const KR = {
   About: "CivIdle에 대하여",
   AbuSimbel: "아부심벨",
   AbuSimbelDesc: "람세스 2세의 효과를 두배로 한다. 모든 인접한 불가사의는 +1의 행복도를 얻는다.",
   AccountActiveTrade: "활성화된 거래",
   AccountChatBadge: "채팅 뱃지",
   AccountCustomColor: "색바꾸기",
   ...
   AccountLevelSupporterPack: "서포터팩을 보유하고 있을 것",
   ...
   CircusMaximusDescV2: "+5의 행복도를 얻습니니다. 모든 음악가길드, 작가길드 그리고 화가길드는 +1의 생산, 저장소 용량 배수를 얻습니다.",
   CityState: "도시 국가",
   CityViewMap: "도시",
   CivIdle: "CivIdle",
